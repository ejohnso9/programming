...
def find_guarded(text):
    """
    return list of all occurences of small letters surrounded by exactly
    three CAPS on each side treating text as a multi-line block
    """
